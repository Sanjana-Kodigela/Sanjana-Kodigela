function clock(){
   ...
   var day=date.getDay()
    ...
    console.log(hh,mm,ss,day,dd,mo,yy)
    var am_pm="AM"
    if(hh>=12){
        am_pm="PM"
        if(hh>12){
    ...
    console.log(MIDIConnectionEvent)

    switch(day){
        case 0:day="Sunday"
        document.body.style.backgroundImage="url(./BackLines.jpg)"
        break;
        case 1:day="Monday"
        document.body.style.backgroundImage="url(./Airplane.jpg)"
        break;
        case 2:day="Tuesday"
        document.body.style.backgroundImage="url(./Sunset.jpg)"
        break;
        case 3:day="Wednesday"
        document.body.style.backgroundImage="url(./Car.jpeg)"
        break;
        case 4:day="Thursday"
        document.body.style.backgroundImage="url(./Train.jpg)"
        break;
        case 5:day="Friday"
        document.body.style.backgroundImage="url(./Bike.jpg)"
        break;
        case 6:day="Saturday"
...
clock()
var audio=new Audio()
audio.src="./AgarThumSathHooSong.mp3"
